...
개발과 테스트 단계로 진입하면서 일하는 시간, 작업량\(time, load\)가 많아진다. 따라서 Waterfall 방법론은 중반부터 업무 강도가 높아지지만, Agile 방법론은 이 과정을 여러번 반복함으로써 처음부터 끝까지 업무 강도가 높다고 느낀다. 때문에 work smat 이지만 work hard 라고 말한다. 
